...
namespace PharmaWeb.Data.Migrations
{
    ...
    [Migration("20220612180010_Dinal")]
    partial class Dinal
    {
            ...
            modelBuilder.Entity("PharmaWeb.Data.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 17,
                            CategoryId = 4,
                            Dscription = "aterproofs the surface and in-depth skin, protects against water spots and humidity, maintains the breathability ",
                            Image = "https://assets.sainsburys-groceries.co.uk/gol/3288603/1/640x640.jpg",
                            IsDeleted = false,
                            Name = "Water resistant platsers",
                            Price = 8.3499999999999996,
